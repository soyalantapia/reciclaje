...
export default function MapPoints() {
  ...
  return (
    <div className="space-y-4">
      ...
      {/* Mapa esquemático */}
      <div className="relative aspect-[4/3] w-full overflow-hidden rounded-2xl border border-border bg-eco-50 bg-eco-grid">
        <div className="absolute inset-0 bg-gradient-to-br from-eco-100/40 to-transparent" />
